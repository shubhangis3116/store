		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
					...
					<ul id="main-nav">  <!-- Accordion Menu -->
						...
						<li> 
							...
							<?php if($page=='index.php' || $page=='category.php'): ?>
						...
						<li>
							...
							<ul>
							<li><a  href="category.php?catid=Indian">Indian</a></li>
							
							
							<li><a  href="category.php?catid=Western">Western</a></li>
							<li><a  href="category.php?catid=Indowestern">Indo-Western</a></li>
						</ul>
					</li>
